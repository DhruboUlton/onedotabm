...
export function CtaSection() {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-[#F7F7F5] border-b border-[#E5E5E2] relative overflow-hidden">
      ...
      <Container size="narrow" className="relative z-10 text-center">
        ...
        {/* Supporting Copy */}
        <p className="text-base sm:text-xl text-[#555555] leading-relaxed max-w-2xl mx-auto mb-10">
          Tell us what you&apos;re working on. We&apos;ll help determine whether you need high-impact paid marketing, custom web application architecture, or the integrated combination of both.
        </p>

        {/* Quick Discipline Pre-selector */}
        <div className="inline-flex flex-wrap items-center justify-center p-1.5 rounded-full bg-[#FFFFFF] border border-[#D8D8D4] mb-10 shadow-xs">
          <button
          ...
          >
            ★ Marketing + Web Development (Recommended)
          </button>
          <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8 border-t border-[#E5E5E2] text-xs text-[#555555]">
          <div className="flex items-center justify-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-[#1400FF]" />
